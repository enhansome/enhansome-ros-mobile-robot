...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 980 | 🐛 193 | 🌐 Python | 📅 2026-08-12
...
* Gazebo: <https://github.com/gazebosim/docs/blob/master/releases.md> ⭐ 87 | 🐛 55 | 🌐 Python | 📅 2026-08-14
...
* "VINS-Fusion": <https://github.com/HKUST-Aerial-Robotics/VINS-Fusion> ⭐ 4,667 | 🐛 212 | 🌐 C++ | 📅 2024-05-23
...
* Graph Optimization Based
  ...
  * [g2o Library](https://github.com/RainerKuemmerle/g2o) ⭐ 3,455 | 🐛 8 | 🌐 C++ | 📅 2026-08-10: Kümmerle, Rainer, et al. "g 2 o: A general framework for graph optimization." 2011 IEEE International Conference on Robotics and Automation. IEEE, 2011.
...
* "ORB-SLAM": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,210 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `Feature + (BA + Pose-Graph)`
...
* "ORB-SLAM2": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,210 | 🐛 805 | 🌐 C++ | 📅 2024-05-15
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 8,950 | 🐛 572 | 🌐 C++ | 📅 2024-07-24
