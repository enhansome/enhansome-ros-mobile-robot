# awesome-ros-mobile-robot with stars
...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 980 | 🐛 191 | 🌐 Python | 📅 2026-08-12
...
* Gazebo: <https://github.com/gazebosim/docs/blob/master/releases.md> ⭐ 87 | 🐛 55 | 🌐 Python | 📅 2026-08-12
...
* "turtlebot3": <https://github.com/ROBOTIS-GIT/turtlebot3> ⭐ 2,037 | 🐛 16 | 🌐 C++ | 📅 2026-06-15
...
* "Universal Robot 3/5/10/e": <https://github.com/ros-industrial/universal_robot> ⭐ 1,410 | 🐛 45 | 🌐 C++ | 📅 2026-07-20
* "Franka Emika panda": <https://github.com/frankaemika/franka_ros> ⭐ 487 | 🐛 118 | 🌐 C++ | 📅 2025-10-24 | <https://github.com/ros-planning/panda_moveit_config> ⭐ 122 | 🐛 7 | 🌐 CMake | 📅 2025-02-06
...
* "Intel RealSense d455/d435/d435i/d415": <https://github.com/intel-ros/realsense> ⭐ 3,414 | 🐛 121 | 🌐 Python | 📅 2026-08-06
...
* "Microsoft kinectv1 with freenect": <https://github.com/ros-drivers/freenect_stack> ⭐ 38 | 🐛 19 | 🌐 C++ | 📅 2020-03-19
...
* "hokuyo\_urg": <http://wiki.ros.org/urg_node> (old: <http://wiki.ros.org/hokuyo_node>
* "hokuyo\_utm": <http://wiki.ros.org/urg_node> (old: <http://wiki.ros.org/hokuyo_node>
...
* "Livox": <https://github.com/hku-mars/loam_livox> ⭐ 1,617 | 🐛 71 | 🌐 C++ | 📅 2020-02-24
...
* "sound\_play": <http://wiki.ros.org/sound_play>
...
* "YOLOv3": <https://github.com/leggedrobotics/darknet_ros> ⭐ 2,440 | 🐛 166 | 🌐 C++ | 📅 2024-07-19
...
* "OpenPose": <https://github.com/CMU-Perceptual-Computing-Lab/openpose> ⭐ 34,360 | 🐛 359 | 🌐 C++ | 📅 2024-08-03
...
* "camera\_calibration": <http://wiki.ros.org/camera_calibration>
* "format converter": <http://wiki.ros.org/camera_calibration_parsers>

👁 Hand-Eye Calibration

* "easy\_handeye": <https://github.com/IFL-CAMP/easy_handeye> ⭐ 1,166 | 🐛 23 | 🌐 Python | 📅 2025-11-30

🍎 IMU (Sparkfun Razer 9dof-razor-imu-m0) Calibration

* "Github Wiki": <https://github.com/Razor-AHRS/razor-9dof-ahrs/wiki/Tutorial> ⭐ 465 | 🐛 60 | 🌐 Arduino | 📅 2020-12-28
* "My Calibration Guide": <https://github.com/shannon112/imu_calibration/blob/master/README.md> ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2020-07-29
...
* "ros\_control": <http://wiki.ros.org/ros_control>
  > Chitta, Sachin, et al. "ros\_control: A generic and simple control framework for ROS." (2017).

💡 2D Laser Based Odometry

* "rf2o": <https://github.com/MAPIRlab/rf2o_laser_odometry> ⭐ 485 | 🐛 27 | 🌐 C++ | 📅 2024-01-31
...
* "VINS-Mono": <https://github.com/HKUST-Aerial-Robotics/VINS-Mono> ⭐ 5,997 | 🐛 293 | 🌐 C++ | 📅 2024-08-14
...
* "DSO": <https://github.com/JakobEngel/dso> ⭐ 2,450 | 🐛 138 | 🌐 C++ | 📅 2024-02-23 `Sparse Direct Method`
...
* "OKVIS": <https://github.com/ethz-asl/okvis> ⭐ 1,364 | 🐛 67 | 🌐 C++ | 📅 2021-08-24 | <https://github.com/ethz-asl/okvis_ros> ⭐ 300 | 🐛 13 | 🌐 C++ | 📅 2019-06-12
...
* "ROVIO": <https://github.com/ethz-asl/rovio> ⭐ 1,261 | 🐛 83 | 🌐 C++ | 📅 2026-01-19
...
* "VINS-Fusion": <https://github.com/HKUST-Aerial-Robotics/VINS-Fusion> ⭐ 4,662 | 🐛 212 | 🌐 C++ | 📅 2024-05-23
...
* "LOAM & V-LOAM": <https://github.com/laboshinl/loam_velodyne> ⭐ 1,755 | 🐛 108 | 🌐 C++ | 📅 2019-06-18
...
* "LIMO": <https://github.com/johannes-graeter/limo> ⭐ 893 | 🐛 6 | 🌐 C++ | 📅 2025-12-28
...
* "DeepVO": <https://github.com/ChiWeiHsiao/DeepVO-pytorch> ⭐ 409 | 🐛 45 | 🌐 Python | 📅 2021-11-15 | <https://github.com/ildoonet/deepvo>
...
* "VINET": <https://github.com/HTLife/VINet> ⭐ 223 | 🐛 8 | 🌐 Python | 📅 2018-06-28
  > Clark, Ronald, et al. "VINet: Visual-Inertial Odometry as a Sequence-to-Sequence Learning Problem." AAAI. 2017.

🍥 Odometry Fusion

* EKF | "robot\_pose\_ekf": <http://wiki.ros.org/robot_pose_ekf>
* EKF & UKF | "robot\_localization": <http://docs.ros.org/melodic/api/robot_localization/html/index.html>
...
* Graph Optimization Based
  ...
  * [g2o Library](https://github.com/RainerKuemmerle/g2o) ⭐ 3,454 | 🐛 8 | 🌐 C++ | 📅 2026-08-10: Kümmerle, Rainer, et al. "g 2 o: A general framework for graph optimization." 2011 IEEE International Conference on Robotics and Automation. IEEE, 2011.
...
* "ORB-SLAM": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,208 | 🐛 805 | 🌐 C++ | 📅 2024-05-15 `Feature + (BA + Pose-Graph)`
...
* "ORB-SLAM2": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,208 | 🐛 805 | 🌐 C++ | 📅 2024-05-15
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 8,941 | 🐛 571 | 🌐 C++ | 📅 2024-07-24
...
* "RTAB-Map": <http://introlab.github.io/rtabmap/> | <https://github.com/introlab/rtabmap_ros> ⭐ 1,492 | 🐛 558 | 🌐 C++ | 📅 2026-08-10
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,881 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
* "Lego-LOAM": <https://github.com/RobustFieldAutonomyLab/LeGO-LOAM> ⭐ 2,751 | 🐛 40 | 🌐 C++ | 📅 2024-08-17
...
* "hdl\_graph\_slam": <https://github.com/koide3/hdl_graph_slam> ⭐ 2,323 | 🐛 126 | 🌐 C++ | 📅 2024-07-16
...
* "ViTa-SLAM": <https://github.com/aalto-intelligent-robotics/ViTa-SLAM> ⭐ 5 | 🐛 1 | 🌐 C++ | 📅 2020-04-09
...
* "Kimera": <https://github.com/MIT-SPARK/Kimera> ⭐ 2,114 | 🐛 2 | 📅 2021-01-30
...
* mrpt\_localization: <http://wiki.ros.org/mrpt_localization>
...
* "map\_server": <http://wiki.ros.org/map_server> `(loading, saving)`
* "octomap\_server": <http://wiki.ros.org/octomap_server> `(loading, saving, mapping)`
...
* "voxblox (ESDF\&TSDF based)": <https://github.com/ethz-asl/voxblox> ⭐ 1,662 | 🐛 77 | 🌐 C++ | 📅 2024-07-01
...
* "OpenChisel (TSDF based)": <https://github.com/personalrobotics/OpenChisel> ⭐ 504 | 🐛 9 | 🌐 C++ | 📅 2024-04-15
...
🚗 ROS Navigation Stack (move\_base architecture) <https://github.com/ros-planning/navigation> ⚠️ Archived

* "move\_base": <http://wiki.ros.org/move_base>
* "move\_base\_flex": <http://wiki.ros.org/move_base_flex>
...
* Reciprocal Velocity Obstacle (RVO) <http://gamma.cs.unc.edu/RVO2/> | <https://github.com/daenny/collvoid> ⭐ 87 | 🐛 5 | 🌐 C++ | 📅 2017-08-04
...
🖐️ ROS Moveit (move\_group architecture) <https://github.com/ros-planning/moveit.git> ⭐ 2,074 | 🐛 621 | 🌐 C++ | 📅 2026-07-20 <img src="https://moveit.ros.org/assets/images/diagrams/moveit_pipeline.png" width=700>
...
# 11\_Others\_Non\_Tech\_Part

## 11-1\_Famous Robotics Related Company

🏬 Robotic Companies

| categories                   | companies                                                                                                                                                                                              |
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Research center              | Toyota\_Research\_Institute(TRI), Microsoft\_Research, Google\_AI, DeepMind, Facebook\_Artificial\_Intelligence\_Research(FAIR), Berkeley\_Artificial\_Intelligence\_Research (BAIR), Nvidia\_Research |
| Manipulator                  | ABB, FANUC, KUKA, YASKAWA, Techman\_Robot, HIWIN, Universal\_Robots, Innfos                                                                                                                            |
| Mobile Robot(AGV, base only) | Omron\_Robotics, Clearpath\_Robotics\&OTTO\_Motors, Amazon\_Robotics(Kiva\_System/Canvas\_Tech), Yujin\_Robotics, ROBOTIS, Fetch\_Robotics, GreenTrans, KUKA, iRobot, Pal\_Robotics, Robotnik          |
| Service robot(with torso)    | Willow\_Garage, Softbank\_Robotics, Fetch\_Robotics, Pal\_Robotics, Innfos, Robotnik                                                                                                                   |
| Dual Arms                    | ABB, Rethink\_Robotics                                                                                                                                                                                 |
| Humanoid                     | Boston\_Dynamics, Softbank\_Robotics, Pal\_Robotics, UBTECH\_Robotics                                                                                                                                  |
| Quadruped                    | Boston\_Dynamics, Unitree\_Robotics, MIT\_Cheetah, ANYrobotics(ANYmal), Standford＿Doggo, Innfos                                                                                                        |
| Research Robot               | Willow\_Garage(Pr2), Facebook(pyrobot), ROBOTIS(turtlebot3), Fetch\_Robotics, Robotnik(RB-1)                                                                                                           |
| Educational Robot Kit        | Trossen\_Robotics, Niryo, Oz\_Robotics                                                                                                                                                                 |
| Drone                        | Dji, Tello                                                                                                                                                                                             |
| ROS2.0                       | ADLINK(DDS), ROBOTIS(Turtlebot3)                                                                                                                                                                       |
| CleaningBot                  | iRobot, Xiaomi                                                                                                                                                                                         |
| Gripper                      | ROBOTIQ, TOYO                                                                                                                                                                                          |
| Self-Driving Cars            | Alphabet\_Waymo, Uber\_ATG, Apple\_Project\_Titan, Tesla, Toyota\_Research\_Institute(TRI), Baidu\_Apollo, AutoX                                                                                       |
| Delivery Robots              | Starship, Amazon\_Robotics\_Scout(Dispatch)                                                                                                                                                            |

## 11-2\_Famous Robotics Publications
...
## 11-3\_Famous Robotics Competition
...
## 11-4\_Famous ROS Organizations & Activities
