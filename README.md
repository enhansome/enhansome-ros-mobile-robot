...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 981 | 🐛 195 | 🌐 Python | 📅 2026-08-12
...
* Gazebo: <https://github.com/gazebosim/docs/blob/master/releases.md> ⭐ 87 | 🐛 55 | 🌐 Python | 📅 2026-08-16
...
* "rf2o": <https://github.com/MAPIRlab/rf2o_laser_odometry> ⭐ 487 | 🐛 27 | 🌐 C++ | 📅 2024-01-31
...
* "LOAM & V-LOAM": <https://github.com/laboshinl/loam_velodyne> ⭐ 1,756 | 🐛 108 | 🌐 C++ | 📅 2019-06-18
...
* Graph Optimization Based
  ...
  * [g2o Library](https://github.com/RainerKuemmerle/g2o) ⭐ 3,457 | 🐛 5 | 🌐 C++ | 📅 2026-08-16: Kümmerle, Rainer, et al. "g 2 o: A general framework for graph optimization." 2011 IEEE International Conference on Robotics and Automation. IEEE, 2011.
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 8,959 | 🐛 572 | 🌐 C++ | 📅 2024-07-24
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,887 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
* "hdl\_graph\_slam": <https://github.com/koide3/hdl_graph_slam> ⭐ 2,324 | 🐛 126 | 🌐 C++ | 📅 2024-07-16
...
* "voxblox (ESDF\&TSDF based)": <https://github.com/ethz-asl/voxblox> ⭐ 1,663 | 🐛 77 | 🌐 C++ | 📅 2024-07-01
