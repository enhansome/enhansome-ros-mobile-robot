...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 1,005 | 🐛 180 | 🌐 Python | 📅 2026-09-08
...
* "turtlebot3": <https://github.com/ROBOTIS-GIT/turtlebot3> ⭐ 2,061 | 🐛 16 | 🌐 C++ | 📅 2026-06-15
...
* "YOLOv3": <https://github.com/leggedrobotics/darknet_ros> ⭐ 2,437 | 🐛 166 | 🌐 C++ | 📅 2024-07-19
...
* "VINS-Fusion": <https://github.com/HKUST-Aerial-Robotics/VINS-Fusion> ⭐ 4,704 | 🐛 212 | 🌐 C++ | 📅 2024-05-23
...
* Graph Optimization Based
  * [g2o Library](https://github.com/RainerKuemmerle/g2o) ⭐ 3,465 | 🐛 6 | 🌐 C++ | 📅 2026-09-07: Kümmerle, Rainer, et al. "g 2 o: A general framework for graph optimization." 2011 IEEE International Conference on Robotics and Automation. IEEE, 2011.
...
* "ORB-SLAM": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,232 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 `Feature + (BA + Pose-Graph)`
...
* "ORB-SLAM2": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,232 | 🐛 806 | 🌐 C++ | 📅 2024-05-15
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 9,057 | 🐛 571 | 🌐 C++ | 📅 2024-07-24
...
* "RTAB-Map": <http://introlab.github.io/rtabmap/> | <https://github.com/introlab/rtabmap_ros> ⭐ 1,514 | 🐛 561 | 🌐 C++ | 📅 2026-09-08
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,910 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
* "voxblox (ESDF\&TSDF based)": <https://github.com/ethz-asl/voxblox> ⭐ 1,668 | 🐛 77 | 🌐 C++ | 📅 2024-07-01
...
🖐️ ROS Moveit (move\_group architecture) <https://github.com/ros-planning/moveit.git> ⭐ 2,084 | 🐛 621 | 🌐 C++ | 📅 2026-07-20 <img src="https://moveit.ros.org/assets/images/diagrams/moveit_pipeline.png" width=700>
