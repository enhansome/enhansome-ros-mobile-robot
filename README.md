...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 1,008 | 🐛 182 | 🌐 Python | 📅 2026-09-15
...
* Gazebo: <https://github.com/gazebosim/docs/blob/master/releases.md> ⭐ 88 | 🐛 51 | 🌐 Python | 📅 2026-09-16
...
* "Intel RealSense d455/d435/d435i/d415": <https://github.com/intel-ros/realsense> ⭐ 3,438 | 🐛 124 | 🌐 Python | 📅 2026-09-16
...
* "VINS-Mono": <https://github.com/HKUST-Aerial-Robotics/VINS-Mono> ⭐ 6,034 | 🐛 293 | 🌐 C++ | 📅 2024-08-14
...
* "VINS-Fusion": <https://github.com/HKUST-Aerial-Robotics/VINS-Fusion> ⭐ 4,716 | 🐛 212 | 🌐 C++ | 📅 2024-05-23
...
* Graph Optimization Based
  * [g2o Library](https://github.com/RainerKuemmerle/g2o) ⭐ 3,466 | 🐛 6 | 🌐 C++ | 📅 2026-09-14: Kümmerle, Rainer, et al. "g 2 o: A general framework for graph optimization." 2011 IEEE International Conference on Robotics and Automation. IEEE, 2011.
...
* "ORB-SLAM": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,235 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 `Feature + (BA + Pose-Graph)`
...
* "ORB-SLAM2": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,235 | 🐛 806 | 🌐 C++ | 📅 2024-05-15
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 9,076 | 🐛 572 | 🌐 C++ | 📅 2024-07-24
...
* "RTAB-Map": <http://introlab.github.io/rtabmap/> | <https://github.com/introlab/rtabmap_ros> ⭐ 1,518 | 🐛 563 | 🌐 C++ | 📅 2026-09-14
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,918 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
* "Kimera": <https://github.com/MIT-SPARK/Kimera> ⭐ 2,126 | 🐛 2 | 📅 2021-01-30
...
🖐️ ROS Moveit (move\_group architecture) <https://github.com/ros-planning/moveit.git> ⭐ 2,087 | 🐛 621 | 🌐 C++ | 📅 2026-07-20 <img src="https://moveit.ros.org/assets/images/diagrams/moveit_pipeline.png" width=700>
