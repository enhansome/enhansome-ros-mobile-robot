...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 1,006 | 🐛 180 | 🌐 Python | 📅 2026-09-14
...
* Gazebo: <https://github.com/gazebosim/docs/blob/master/releases.md> ⭐ 88 | 🐛 51 | 🌐 Python | 📅 2026-09-14
...
* "turtlebot3": <https://github.com/ROBOTIS-GIT/turtlebot3> ⭐ 2,062 | 🐛 16 | 🌐 C++ | 📅 2026-06-15
...
* "Intel RealSense d455/d435/d435i/d415": <https://github.com/intel-ros/realsense> ⭐ 3,434 | 🐛 125 | 🌐 Python | 📅 2026-09-07
...
* "VINS-Mono": <https://github.com/HKUST-Aerial-Robotics/VINS-Mono> ⭐ 6,031 | 🐛 293 | 🌐 C++ | 📅 2024-08-14
...
* "VINS-Fusion": <https://github.com/HKUST-Aerial-Robotics/VINS-Fusion> ⭐ 4,713 | 🐛 212 | 🌐 C++ | 📅 2024-05-23
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 9,064 | 🐛 571 | 🌐 C++ | 📅 2024-07-24
...
* "RTAB-Map": <http://introlab.github.io/rtabmap/> | <https://github.com/introlab/rtabmap_ros> ⭐ 1,517 | 🐛 563 | 🌐 C++ | 📅 2026-09-14
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,913 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
* "hdl\_graph\_slam": <https://github.com/koide3/hdl_graph_slam> ⭐ 2,336 | 🐛 126 | 🌐 C++ | 📅 2024-07-16
...
🖐️ ROS Moveit (move\_group architecture) <https://github.com/ros-planning/moveit.git> ⭐ 2,085 | 🐛 621 | 🌐 C++ | 📅 2026-07-20 <img src="https://moveit.ros.org/assets/images/diagrams/moveit_pipeline.png" width=700>
