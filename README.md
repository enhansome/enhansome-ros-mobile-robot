...
* ROS2: <https://github.com/ros2/ros2_documentation/blob/rolling/source/Releases.rst> ⭐ 1,009 | 🐛 185 | 🌐 Python | 📅 2026-09-15
...
* "turtlebot3": <https://github.com/ROBOTIS-GIT/turtlebot3> ⭐ 2,064 | 🐛 16 | 🌐 C++ | 📅 2026-06-15
...
* "Intel RealSense d455/d435/d435i/d415": <https://github.com/intel-ros/realsense> ⭐ 3,440 | 🐛 124 | 🌐 Python | 📅 2026-09-17
...
* "ORB-SLAM": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,236 | 🐛 806 | 🌐 C++ | 📅 2024-05-15 `Feature + (BA + Pose-Graph)`
...
* "ORB-SLAM2": <https://github.com/raulmur/ORB_SLAM2> ⭐ 10,236 | 🐛 806 | 🌐 C++ | 📅 2024-05-15
...
* "ORB-SLAM3": <https://github.com/UZ-SLAMLab/ORB_SLAM3> ⭐ 9,080 | 🐛 572 | 🌐 C++ | 📅 2024-07-24
...
* "RTAB-Map": <http://introlab.github.io/rtabmap/> | <https://github.com/introlab/rtabmap_ros> ⭐ 1,519 | 🐛 563 | 🌐 C++ | 📅 2026-09-17
...
* "LIO-SAM": <https://github.com/TixiaoShan/LIO-SAM> ⭐ 4,919 | 🐛 183 | 🌐 C++ | 📅 2025-02-14 (handheld device)
...
🖐️ ROS Moveit (move\_group architecture) <https://github.com/ros-planning/moveit.git> ⭐ 2,089 | 🐛 621 | 🌐 C++ | 📅 2026-07-20 <img src="https://moveit.ros.org/assets/images/diagrams/moveit_pipeline.png" width=700>
